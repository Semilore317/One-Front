...
void Game::update(float deltaTime) {
  ...
  player.update(deltaTime, controls, world.groundY, world.leftBound,
                world.rightBound, world.platforms);
}
...
void Game::draw() const {
  ...
  // the ground
  DrawLine(world.leftBound, world.groundY, world.rightBound, world.groundY,
           BROWN);
